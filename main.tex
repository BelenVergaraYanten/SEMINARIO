...
\draw  [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ] (322,30) .. controls (322,25.58) and (325.58,22) .. (330,22) -- (384,22) .. controls (388.42,22) and (392,25.58) .. (392,30) -- (392,54) .. controls (392,58.42) and (388.42,62) .. (384,62) -- (330,62) .. controls (325.58,62) and (322,58.42) .. (322,54) -- cycle ;
%Straight Lines [id:da7367558222762194] 
\draw [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ]   (357,61) -- (357,97.5) ;
%Straight Lines [id:da2803972739988312] 
\draw [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ]   (249,97.5) -- (482,97) ;
%Straight Lines [id:da362184163228376] 
\draw [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ]   (250,98) -- (250,135.5) ;
\draw [shift={(250,137.5)}, rotate = 270] [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da2822998530903369] 
\draw [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ]   (481,97) -- (481,134.5) ;
\draw [shift={(481,136.5)}, rotate = 270] [color={rgb, 255:red, 80; green, 227; blue, 194 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Flowchart: Alternative Process [id:dp5404788437842312] 
\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (191,151.59) .. controls (191,145.74) and (195.74,141) .. (201.59,141) -- (299.41,141) .. controls (305.26,141) and (310,145.74) .. (310,151.59) -- (310,190.91) .. controls (310,196.76) and (305.26,201.5) .. (299.41,201.5) -- (201.59,201.5) .. controls (195.74,201.5) and (191,196.76) .. (191,190.91) -- cycle ;
%Flowchart: Alternative Process [id:dp13939804311041626] 
\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (422,150.59) .. controls (422,144.74) and (426.74,140) .. (432.59,140) -- (530.41,140) .. controls (536.26,140) and (541,144.74) .. (541,150.59) -- (541,189.91) .. controls (541,195.76) and (536.26,200.5) .. (530.41,200.5) -- (432.59,200.5) .. controls (426.74,200.5) and (422,195.76) .. (422,189.91) -- cycle ;
%Shape: Rectangle [id:dp47214893551343007] 
\draw  [color={rgb, 255:red, 189; green, 16; blue, 224 }  ,draw opacity=1 ] (197,241.5) -- (306,241.5) -- (306,343.5) -- (197,343.5) -- cycle ;
%Straight Lines [id:da6825128183459126] 
\draw [color={rgb, 255:red, 189; green, 16; blue, 224 }  ,draw opacity=1 ]   (250,203.5) -- (249.05,238.5) ;
\draw [shift={(249,240.5)}, rotate = 271.55] [color={rgb, 255:red, 189; green, 16; blue, 224 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6217264285473851] 
\draw [color={rgb, 255:red, 189; green, 16; blue, 224 }  ,draw opacity=1 ]   (483,203.5) -- (482.65,216.46) -- (482.05,238.5) ;
\draw [shift={(482,240.5)}, rotate = 271.55] [color={rgb, 255:red, 189; green, 16; blue, 224 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Rectangle [id:dp11996974312697062] 
\draw  [color={rgb, 255:red, 189; green, 16; blue, 224 }  ,draw opacity=1 ] (357,244.5) -- (617,244.5) -- (617,436.5) -- (357,436.5) -- cycle ;
